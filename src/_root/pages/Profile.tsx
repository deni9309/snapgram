  ...
  return (
    <div className="profile-container">
      <div className="profile-inner_container">
        <div className="flex flex-col xl:flex-row flex-1 gap-7 max-xl:items-center">
          <img
          ...
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            ...
            <div className="flex justify-center xl:justify-start items-center flex-wrap gap-8 mt-10 z-20">
              ...
              <StatBlock value={5} label="Following" />
            </div>
          ...
          <div className="flex justify-center gap-4">
            <div className={`${user.id !== currentUser.$id && 'hidden'}`}>
              <Link to={`/update-profile/${currentUser.$id}`} className={`flex-center gap-2 h-12 bg-dark-4 text-light-1 px-2 rounded-lg ${user.id !== currentUser.$id && 'hidden'}`}>
                <img src="/assets/icons/edit.svg" alt="edit" width={20} height={20} />
                <p className="flex whitespace-normal small-medium">Edit Profile</p>
              </Link>
            </div>
